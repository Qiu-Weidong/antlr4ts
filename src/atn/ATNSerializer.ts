...
// import { IntegerList, IntervalSet, Interval, UUID } from "../misc";
...
// interface CodePointSerializer {
// 	serializeCodePoint(data: IntegerList, cp: number): void;
// }
...
// 	//  constructor(atn: ATN, tokenNames: Array<string>, ruleNames: Array<string>)  {
// 	// 	assert(atn.grammarType != null);
// 	// 	this.atn = atn;
// 	// 	this.ruleNames = ruleNames;
...
// 		let sets: Map<IntervalSet, Boolean> = new LinkedHashMap<IntervalSet, Boolean>();
...
// 		let bmpSets: List<IntervalSet> = new ArrayList<IntervalSet>();
// 		let smpSets: List<IntervalSet> = new ArrayList<IntervalSet>();
...
// 				}
// 			});
// 		let setIndices: Map<IntervalSet, Integer> = new HashMap<IntervalSet, Integer>();
...
// 			codePointSerializer: CodePointSerializer): void
// 	{
...
// 			if (containsEof && set.intervals[0].b === Token.EOF) {
...
// 		}
// 		let numBMPSets: number = ATNDeserializer.toInt(data[p++]);
...
// 		let numSMPSets: number = ATNDeserializer.toInt(data[p++]);
...
// 	private appendSets(buf: StringBuilder, data: char[], p: number, nsets: number, setIndexOffset: number, unicodeDeserializer: ATNDeserializer.UnicodeDeserializer): number {
